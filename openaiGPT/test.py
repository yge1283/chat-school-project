...
#객체 생성
gpt=gpt(input('Type your OpenAi Api key:'))
...
Choose your task
    ...
    if a =='1':
        print
        gpt.define_systemRole(input('Type system role:'))
    elif a=='2':
        gpt.setApiKey(input('Type your api key:'))
    elif a=='3':
        gpt.get_response(input('Type your question:'))
    elif a=='q':
        print('exit')
        break
    else: print('pls choose one below!')
